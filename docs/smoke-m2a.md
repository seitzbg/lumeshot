...
- [ ] Import a real .sxcu (e.g. an Imgur or self-hosted config) → "Uploader imported" notification; it becomes active only if it is the first uploader; otherwise the selection is preserved
