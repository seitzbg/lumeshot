...
**Status:** M2a — capture + share: after-capture upload to a ShareX .sxcu custom uploader or Imgur, copy-URL, local SQLite history. Design: docs/superpowers/specs/2026-07-10-sharex-mac-design.md · Build: `scripts/remote.sh build` (see spec §4 for the SSH dev loop).
