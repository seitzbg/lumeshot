...
/// The URL(s) a successful upload produced, decoupled from LumeshotUpload's
/// `UploadResult` so this LumeshotCore-level delivery core takes no LumeshotUpload dependency.
...
public enum RecordingDelivery {
    ...
    public static func deliver(
        ...
        // row before any upload preserves local-first. Best-effort — LumeshotCore has
